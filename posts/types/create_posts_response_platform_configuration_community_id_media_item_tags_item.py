...
class CreatePostsResponsePlatformConfigurationCommunityIdMediaItemTagsItem(UniversalBaseModel):
    id: str
    type: CreatePostsResponsePlatformConfigurationCommunityIdMediaItemTagsItemType
    platform: CreatePostsResponsePlatformConfigurationCommunityIdMediaItemTagsItemPlatform
