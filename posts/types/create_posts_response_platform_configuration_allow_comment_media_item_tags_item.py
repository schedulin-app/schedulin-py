...
class CreatePostsResponsePlatformConfigurationAllowCommentMediaItemTagsItem(UniversalBaseModel):
    id: str
    type: CreatePostsResponsePlatformConfigurationAllowCommentMediaItemTagsItemType
    platform: CreatePostsResponsePlatformConfigurationAllowCommentMediaItemTagsItemPlatform
